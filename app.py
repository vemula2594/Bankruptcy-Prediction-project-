...
if menu_id == 'Home':
    ...
    with tab1:
        ...
        with col1:
          image = Image.open(r"C:/Users/Dell/OneDrive/Desktop/python_ds/bank/sunrise.jpg")
          st.image(image)

    with tab1:
          st.title('About Project')
          st.text('Project Is Designed by Vemula_Jagadish - Group-4. For details, see in About me.')
    ...
    with col2:
             with open(r'C:\Users\Dell\OneDrive\Desktop\python_ds\bank\group.mp4' , 'rb') as video_file:
    ...
    with tab2:
        ...
        with col1:
          st.markdown("""
              # Hello 👋 everyone My name is   Jagadish_Vemula
    ...
    """)
          with col2:
               with open(r'C:\Users\Dell\OneDrive\Desktop\python_ds\bank\me.mp4', 'rb') as video_file:
                video_bytes = video_file.read()
                st.video(video_bytes)
    ...
    with col1:
        ...
        st.write('[GitHub](https://github.com/vemula2594)')
        st.write('[LinkedIn](https://www.linkedin.com/in/jagadish-vemula-599415206/)')
